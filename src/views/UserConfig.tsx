...
export function UserConfig() {
  ...
  return (
    <div className='flex flex-col h-full w-full overflow-hidden'>
      ...
      <main className={`flex-1 mx-auto max-w-7xl h-full ${isMobile ? 'pb-8 px-1' : 'py-8 px-6'}`}>
        <div
          className={
            isMobile ? 'flex flex-col gap-2 min-h-0 mx-auto' : 'grid grid-cols-[76%_24%] gap-2 min-h-0 mx-auto'
          }>
          {isMobile && (
            <div>
          ...
          <div className='flex flex-col h-full bg-tw-surface-deep px-4 py-4 overflow-y-auto rounded-xl border border-tw-border backdrop-blur-xl gap-6'>
