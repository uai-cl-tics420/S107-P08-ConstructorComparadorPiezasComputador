...
export function Pagination({
  ...
  const getPageNumbers = () => {
    ...
    const showPages = 5; // Show 5 page buttons
    ...
    <motion.div
      ...
      <div className='flex flex-col sm:flex-row items-center justify-between gap-4'>
        ...
        <div className='font-mono text-xs text-tw-muted'>
          Mostrando <span className='text-tw-muted-highlight font-semibold'>{startItem}</span> a{' '}
          <span className='text-tw-muted-highlight font-semibold'>{endItem}</span> de{' '}
          <span className='text-tw-muted-highlight font-semibold'>{totalItems}</span> componentes
        </div>
      </div>
